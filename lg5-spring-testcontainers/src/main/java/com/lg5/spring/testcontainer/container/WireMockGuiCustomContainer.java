...
import static com.lg5.spring.testcontainer.util.Constant.WIREMOCK__GUI_NETWORK_ALIAS;
import static com.lg5.spring.testcontainer.util.Constant.WIREMOCK__GUI_PORT_DEFAULT;
import static com.lg5.spring.testcontainer.util.Constant.network;

/**
 * Images:
 * - WIREMOCK__GUI_V_3_6_31
 */
public class WireMockGuiCustomContainer extends GenericContainer<AppCustomContainer> {
    ...
    public WireMockGuiCustomContainer(DockerImageName dockerImageName) {
        ...
        this.withExposedPorts(WIREMOCK__GUI_PORT_DEFAULT);
        this.withNetwork(network);
        this.withNetworkAliases(WIREMOCK__GUI_NETWORK_ALIAS);
